...
- **organisations**: naam*, website, linkedin, sector, **relatietype** (prospect/lead/klant/partner/overig, default prospect), **doelgroep** (zzp/mkb/aanbieder/overig), logo→media, notities, tags[], eigenaar→users. Joins: `contacten`, `deals`, `projecten`.
- **contacts**: voornaam*, achternaam, `naam` (auto), **email* uniek** (matchsleutel), extraEmails[], telefoons[], functie, organisatie→, bron, **relatietype**, **doelgroep**, tags[], eigenaar→. Join: `deals`.
